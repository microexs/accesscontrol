...
var AccessControl = /** @class */ (function () {
     ...
     */
    AccessControl.prototype.extendRole = function (subjects, extenderRoles) {
        if (this.isLocked)
            throw new core_1.AccessControlError(utils_1.ERR_LOCK);
        utils_1.utils.extendRole(this._grants, subjects, extenderRoles);
        return this;
    };
    /**
    ...
    AccessControl.prototype.removeRoles = function (subjects) {
        ...
        utils_1.utils.eachRole(this._grants, function (subjectItem, subjectName) {
            if (Array.isArray(subjectItem.$extend)) {
                subjectItem.$extend = utils_1.utils.subtractArray(subjectItem.$extend, subjectsToRemove);
            }
        });
        return this;
    };
    ...
    AccessControl.prototype.grant = function (subject) {
        ...
        // other explicit invalid values will be checked in constructor.
        return new core_1.Access(this, subject, false);
    };
    /**
     *  Alias of `grant()`.
     *  @private
    ...
    AccessControl.prototype.deny = function (subject) {
        ...
        // other explicit invalid values will be checked in constructor.
        return new core_1.Access(this, subject, true);
    };
    /**
     *  Alias of `deny()`.
     *  @private
