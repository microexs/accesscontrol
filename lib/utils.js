...
var utils = {
    ...
    getInspectedGrants: function (o) {
        ...
        if (type === 'object') {
            utils.eachKey(o, function (subjectName) {
                if (utils.validName(subjectName)) {
    ...
    getRoleHierarchyOf: function (grants, subjectName, rootRole) {
        ...
        var arr = [subjectName];
        if (!Array.isArray(subject.$extend) || subject.$extend.length === 0)
            return arr;
        subject.$extend.forEach(function (exRoleName) {
     ...
     */
    extendRole: function (grants, subjects, extenderRoles) {
